...
**Your Answers here:**
1. colnames(ProjectData[53]) - [1] "Q16_Name.of.the.Brand.rated
2a. > which(colnames(ProjectData)=="Q1_3_The.brand.of.boat.I.buy.says.a.lot.about.who.I.am") - [1] 4  
2b. > mean(ProjectData[,4]) - [1] 3.115535
3a. > 100*sum(ProjectData[,48]==1)/nrow(ProjectData) - [1] 55.10132 
3b. > 100*(sum(ProjectData[,48]==1&ProjectData[,33]==5)/nrow(ProjectData)+sum(ProjectData[,48]==1&ProjectData[,33]==4)/nrow(ProjectData))
